...
/*   Updated: 2020/11/19 18:05:21 by bharrold         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** packet_create creates new packet with type(IPPROTO_ICMP,
...
*/
void				packet_fill_icmp(t_packet *packet, uint8_t type,
	uint8_t code);

/*
** packet_fill_udp fills packet udp header
*/
void				packet_fill_udp(t_packet *packet,
...
*/
void				calc_icmp_cksum(t_icmphdr *icmphdr,
	t_packet *packet, uint16_t offset);

/*
** calc_udp_cksum calcs udp checksum.
*/
void				calc_udp_cksum(t_udphdr *udphdr,
	t_packet *packet, uint16_t offset);
...
t_socket			socket_create(int32_t protocol, int32_t hdrincl,
	int32_t broadcast, int32_t timeout);
void				socket_close(t_socket socket);
int					send_socket_raw(t_socket socket, int32_t flags,
	t_packet *pckt);
int					socket_settimeout(t_socket sock,
	int32_t timeout_sec);
